...
#ifdef MSVC
typedef short a __declspec(align(8)) ;
#else
...
#ifdef MSVC
typedef short b __declspec(align(4)) ;
#else
...
#ifdef MSVC
typedef int c __declspec(align(8)) ;
#else
...
#ifdef MSVC
typedef long long d __declspec(align(4)) ;
#else
...
#ifdef MSVC
typedef int e __declspec(align(2)) ;
#else
