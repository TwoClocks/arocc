...
typedef struct {
#ifdef MSVC
    long long a __declspec(align(4)) ;
#else
...
typedef struct {
#ifdef MSVC
    int b:3 __declspec(align(1024)) ;
} __declspec(align(8))  RB0;
#else
...
#ifdef MSVC
typedef PA PB __declspec(align(8)) ;
#else
...
#ifdef MSVC
typedef int QA __declspec(align(2)) ;
#else
...
#ifdef MSVC
} __declspec(align(4))  EmptyAlignedLongLongMemb;
#else
...
#ifdef MSVC
} __declspec(align(4))  EmptyPackedAlignedLongLongMemb;
#else
...
_Static_assert(sizeof(struct EmptyPackedAlignedLongLongMemb_extra_size) == 2, "");
_Static_assert(_Alignof(struct EmptyPackedAlignedLongLongMemb_extra_size) == 1, "");
// MAPPING|SIX|i386-i386-ios-none:Clang|i386-i586-linux-gnu:Gcc|i386-i586-linux-musl:Gcc|i386-i686-macos-none:Clang|i386-i686-linux-android:Clang|i386-i686-freebsd-gnu:Clang|i386-i686-haiku-gnu:Clang|i386-i686-linux-gnu:Gcc|i386-i686-linux-musl:Gcc|i386-i686-netbsd-gnu:Clang|i386-i686-openbsd-gnu:Clang|END
