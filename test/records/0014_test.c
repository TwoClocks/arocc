...
#ifdef MSVC
typedef int A __declspec(align(1)) ;
#else
...
#ifdef MSVC
typedef int B __declspec(align(2)) ;
#else
...
#ifdef MSVC
typedef int C __declspec(align(4)) ;
#else
...
#ifdef MSVC
typedef int D __declspec(align(8)) ;
#else
...
#ifdef MSVC
typedef int E __declspec(align(16)) ;
#else
...
#ifdef MSVC
typedef int F __declspec(align(32)) ;
#else
...
#ifdef MSVC
typedef int G __declspec(align(64)) ;
#else
...
#ifdef MSVC
typedef int H __declspec(align(128)) ;
#else
...
#ifdef MSVC
typedef A AA __declspec(align(1)) ;
#else
...
#ifdef MSVC
typedef A AB __declspec(align(2)) ;
#else
...
#ifdef MSVC
typedef A AC __declspec(align(4)) ;
#else
...
#ifdef MSVC
typedef A AD __declspec(align(8)) ;
#else
...
#ifdef MSVC
typedef A AE __declspec(align(16)) ;
#else
...
#ifdef MSVC
typedef A AF __declspec(align(32)) ;
#else
...
#ifdef MSVC
typedef A AG __declspec(align(64)) ;
#else
...
#ifdef MSVC
typedef A AH __declspec(align(128)) ;
#else
...
#ifdef MSVC
typedef B BA __declspec(align(1)) ;
#else
...
#ifdef MSVC
typedef B BB __declspec(align(2)) ;
#else
...
#ifdef MSVC
typedef B BC __declspec(align(4)) ;
#else
...
#ifdef MSVC
typedef B BD __declspec(align(8)) ;
#else
...
#ifdef MSVC
typedef B BE __declspec(align(16)) ;
#else
...
#ifdef MSVC
typedef B BF __declspec(align(32)) ;
#else
...
#ifdef MSVC
typedef B BG __declspec(align(64)) ;
#else
...
#ifdef MSVC
typedef B BH __declspec(align(128)) ;
#else
...
#ifdef MSVC
typedef D DA __declspec(align(1)) ;
#else
...
#ifdef MSVC
typedef D DB __declspec(align(2)) ;
#else
...
#ifdef MSVC
typedef D DC __declspec(align(4)) ;
#else
...
#ifdef MSVC
typedef D DD __declspec(align(8)) ;
#else
...
#ifdef MSVC
typedef D DE __declspec(align(16)) ;
#else
...
#ifdef MSVC
typedef D DF __declspec(align(32)) ;
#else
...
#ifdef MSVC
typedef D DG __declspec(align(64)) ;
#else
...
#ifdef MSVC
typedef D DH __declspec(align(128)) ;
#else
