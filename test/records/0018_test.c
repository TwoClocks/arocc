...
#ifdef MSVC
typedef char unnamed_type_5 __declspec(align(4)) ;
#else
...
#ifdef MSVC
typedef char unnamed_type_15 __declspec(align(4)) ;
#else
...
#ifdef MSVC
typedef short unnamed_type_32 __declspec(align(4)) ;
#else
...
#ifdef MSVC
typedef short unnamed_type_42 __declspec(align(4)) ;
#else
...
#ifdef MSVC
typedef long long unnamed_type_59 __declspec(align(128)) ;
#else
...
#ifdef MSVC
typedef long long unnamed_type_69 __declspec(align(128)) ;
#else
