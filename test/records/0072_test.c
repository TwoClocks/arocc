...
#ifdef MSVC
typedef int C __declspec(align(16)) ;
#else
...
_Static_assert(__builtin_bitoffsetof(E,a) == 0, "");
#endif
// MAPPING|SIX|i386-i586-windows-msvc:Msvc|i386-i686-windows-msvc:Msvc|i386-i686-uefi-msvc:Msvc|x86_64-x86_64-windows-msvc:Msvc|x86_64-x86_64-uefi-msvc:Msvc|END
