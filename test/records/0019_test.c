...
_Static_assert(sizeof(struct E_extra_size) == 10, "");
_Static_assert(_Alignof(struct E_extra_size) == 1, "");
// MAPPING|FIVE|i386-i586-linux-gnu:Gcc|i386-i586-linux-musl:Gcc|i386-i686-linux-gnu:Gcc|i386-i686-linux-musl:Gcc|END
