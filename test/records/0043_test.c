...
typedef struct {
#ifdef MSVC
    unnamed_type_19 FlexArrayMemb __declspec(align(2)) ;
#else
...
typedef struct {
#ifdef MSVC
    unnamed_type_28 FlexArrayMemb __declspec(align(8)) ;
#else
...
#ifdef MSVC
} __declspec(align(4))  EmptyPackedAligned4LongLongMemb;
#else
...
typedef struct {
#ifdef MSVC
    unnamed_type_46 FlexArrayMemb __declspec(align(8)) ;
#else
